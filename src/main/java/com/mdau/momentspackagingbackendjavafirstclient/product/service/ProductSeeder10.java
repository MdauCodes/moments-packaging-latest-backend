...
public class ProductSeeder10 implements ApplicationRunner {
    ...
    private static final Object[][] PRODUCTS = {
            // TODO: populate with real data from the original ProductSeeder10
            // Example entry:
    ...
    public void run(ApplicationArguments args) {
        ...
        if (PRODUCTS.length == 0) {
            log.warn("ProductSeeder10: PRODUCTS array is empty — skipping. Please populate with real data.");
            return;
        }
